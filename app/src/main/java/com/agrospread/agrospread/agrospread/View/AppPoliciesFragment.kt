...
class AppPoliciesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_app_policies, container, false)
        ...
        // Handle back button
        val backButton: Button = view.findViewById(R.id.backToSettingsPolicyBtn)
