...
import com.agrospread.agrospread.databinding.ActivitySeedDetailBinding

class SeedDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            val image = intent.getIntExtra("image", R.drawable.seed)
            ...
            binding.addtocartButton.setOnClickListener {
                ...
                val selectedItem = ListData(
                    name = "4 Season Vegetable seeds",
                    image = R.drawable.seed,
                    price = "Price: 105",
                    quantity = quantity
                )
    ...
    private fun addToCart(item: ListData) {
        ...
        if (existingItem != null) {
            ...
            Toast.makeText(this@SeedDetail, "Item is already in the cart", Toast.LENGTH_SHORT).show()
        } else {
            // Item doesn't exist, add it to the cart
            cartItems.add(item)
            Log.d("SeedDetail", "Item added to cart: ${item.name}")
            Log.d("SeedDetail", "Current cart items: $cartItems")
            Toast.makeText(this@SeedDetail, "Item added to cart", Toast.LENGTH_SHORT).show()
        }
    }
